...
<Footer
	class="text-black dark:text-white fixed bottom-0 start-0 z-20 w-full p-4 h-20 bg-gray-300 border-t-4 dark:border-blue-600 border-black  shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 "
>
	...
	>
		<FooterLink href="https://github.com/Antonio-Riccelli" target="_blank" classLi="dark:hover:bg-blue-600 hover:bg-white rounded-full p-1 hover:animate-spin">
      ...
      <span class="sr-only">GitHub account</span>
		...
		>
		<FooterLink href="https://www.linkedin.com/in/antonioriccelli/" target="_blank" classLi="dark:hover:bg-blue-600 hover:bg-white rounded-full p-1 hover:animate-spin">
      <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
